# File for all global used functions
import time
import random
...
def welcome_message():
    print ("\n- - - - - - - - - - - - - - - - - -")
    print ("Before trying to run this proxy, in your computer advanced network setting,")
    print ("Remember to set the input host and port as server and port number for your Web Proxy(HTTP) option.")
    print ("- - - - - - - - - - - - - - - - - - -")
